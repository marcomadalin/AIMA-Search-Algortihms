...
//        String file_name = "debug";
        BufferedWriter w1 = new BufferedWriter(new FileWriter("experiment6.txt"));
...
//        BufferedWriter w3 = new BufferedWriter(new FileWriter(file_name +"-temps.txt"));
        ...
        for (int i = 0; i < 15; ++i) {
            ...
            azamon_local_search(a, 1, 2, 1, w1, null, null, startTime);
        }
        ...
        for (int i = 0; i < 15; ++i) {
            ...
            AzamonState a = new AzamonState(100, rand.nextInt(), rand.nextInt(), 1.2);
            a.generate_solution2();
            azamon_local_search(a, 2, 1, 1, w1, null, null, startTime);
        }
...
//            w3.write(totalTime + "\n");
            ...
            w1.write(fin.get_cost() + "\t" + fin.get_happiness() + "\n");
